...
import { getStudycaseBySlug } from '@/lib/studycase';
import { Metadata } from 'next';

interface StudycasePageProps {
  params: Promise<{ slug: string }>;
  searchParams: Promise<{ draft?: string }>;
}

export async function generateMetadata({params}: StudycasePageProps): Promise<Metadata> {
  const post = await getStudycaseBySlug((await params).slug, false);
...
export default async function StudycasePage({
  ...
  const post = await getStudycaseBySlug(slug, draft === 'true');
            ...
            {relatedPosts.map((relatedPost) => {
              ...
              return (
                <Link
                  ...
                  href={`/studycase/${relatedPost.slug}`}
