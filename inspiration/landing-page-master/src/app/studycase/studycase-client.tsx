...
export default function StudycaseClient({
  posts,
  categories,
}: BlogClientProps) {
  ...
  const featuredPost = posts[0]; // Always show the newest post overall
  const allRegularPosts = filteredPosts; // Show all filtered posts in grid
    ...
    <section className="section-padding bigger-container overflow-hidden">
      ...
      <div className="">
        ...
        <p className="text-muted-foreground mt-3 hidden text-lg leading-relaxed md:block lg:mt-4">
          Citește ultimele noutăți, sfaturi și resurse
        </p>

        {featuredPost && (
          <Link
            href={`/studycase/${featuredPost.slug}`}
                  ...
                  >
                    <div className="flex gap-8 text-xs">
                      ...
                      <div className="flex flex-col space-y-2">
                        <div className="font-medium">Publicat pe </div>
    ...
    >
      ...
      <CardContent className="mb-8 px-5">
        <div className="mb-3 flex items-center justify-between">
          <span className="text-lg">{post.mainCategory}</span>
