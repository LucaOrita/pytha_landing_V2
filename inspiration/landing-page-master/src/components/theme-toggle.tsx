    ...
    >
      ...
      >
        <m.path
          ...
          d={moonPath}
          className={'stroke-ternary absolute top-0 left-0'}
          initial="hidden"
        ...
        <m.g
          ...
          className="stroke-ternary stroke-6"
        ...
        <m.path
          ...
          animate={{
            ...
            stroke: theme === 'dark' ? 'var(--ternary)' : 'var(--ternary)',
            fill: theme === 'dark' ? 'var(--ternary)' : 'var(--ternary)',
            fillOpacity: 0.35,
            strokeOpacity: 1,
