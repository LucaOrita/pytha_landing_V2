...
// iconuri template - import { BarChart3, Clock, Filter, Link } from 'lucide-react';
import { ScanSearch, Database, Workflow, History } from 'lucide-react';
...
const features = [
  {
    id: 'changes',
    icon: ScanSearch,
    title: 'Detectezi rapid modificările din documente',
    description:
      'DOCO evidențiază vizual modificările și neconcordanțele, astfel încât vezi imediat ce trebuie verificat.',
    image: {
      src: '/images/features-carousel/1.webp',
      alt: 'Evidențiere modificări și neconcordanțe în documente',
      width: 400,
      height: 400,
      className: 'ps-4 pt-4',
    },
  },
  {
    id: 'data-extraction',
    icon: Database,
    title: 'Date esențiale extrase automat',
    description:
      'AI-ul extrage câmpuri cheie din documentele de transport, gata de folosit în procesele tale.',
    image: {
      src: '/images/features-carousel/2.webp',
      alt: 'Extracție automată de date din documente',
      width: 400,
      height: 400,
      className: 'pt-4',
    },
  },
  {
    id: 'guided-procedure',
    icon: Workflow,
    title: 'Procedură ghidată pentru verificarea furnizorilor',
    description:
      'Dispecerii urmează pași clari, standardizați, pentru a verifica furnizorii și documentele fiecărui transport.',
    image: {
      src: '/images/features-carousel/3.webp',
      alt: 'Flux ghidat de verificare a furnizorilor',
      width: 400,
      height: 400,
      className: 'p-4',
    },
  },
  {
    id: 'history',
    icon: History,
    title: 'Istoric și trasabilitate pentru fiecare verificare',
    description:
      'Păstrezi o urmă clară a verificărilor și deciziilor, utilă pentru audit, controale și discuții cu partenerii.',
    image: {
      src: '/images/features-carousel/4.webp',
      alt: 'Istoric și trasabilitate a verificărilor',
      width: 400,
      height: 400,
      className: 'pt-4',
    },
    ...
    >
      ...
      <div className="container grid gap-8 lg:grid-cols-3 lg:gap-40">
        ...
        <div className="flex flex-col gap-8 lg:col-span-1">
          ...
          >
            <h2 className="text-primary text-3xl tracking-tight text-balance md:text-4xl lg:text-4xl">
              E important{' '}
              <span className="text-muted-foreground/80">
                să vezi riscurile din documente
              </span>
            </h2>

            <p className="text-muted-foreground text-base leading-relaxed text-balance md:text-lg">
              <span className="text-secondary font-semibold">DOCO</span>{' '}
              analizează documentele de transport, scoate în evidență potențiale
              neconcordanțe și îți oferă contextul necesar pentru decizii
              operaționale mai sigure.
            </p>
          </motion.div>
          ...
          >
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <IconComponent
                    className="group-hover:text-primary hover:text-primary size-5 transition-colors duration-300"
                    strokeWidth={2.1}
                  />
                </motion.button>
              );
