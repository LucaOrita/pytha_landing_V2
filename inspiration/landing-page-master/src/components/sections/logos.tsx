...
import { Logos8 } from '../logos8';

const companies = [
  {
    name: 'Dacoda',
    logo: '/images/logos/logo_dacoda.webp',
    className: 'h-16 lg:h-32 w-auto',
    url: 'https://www.dacoda.ro/',
  },
  {
    name: 'USER',
    logo: '/images/logos/logo_user.webp',
    className: 'h-16 lg:h-32 w-auto',
    url: 'https://user.ro/',
  },
  // {
...
export default function Logos() {
  ...
  return (
    <section className="section-padding relative">
      ...
      <Logos8 title="Partenerii noștri" subtitle="" logos={companies} />
