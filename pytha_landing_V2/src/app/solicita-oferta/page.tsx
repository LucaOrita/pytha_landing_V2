      ...
      <div className="container">
        <div className="grid gap-12 lg:grid-cols-[1fr_380px] lg:gap-18">
          ...
          <div>
            ...
            <div className="mt-8">
              <Suspense fallback={<div className="h-96 animate-pulse rounded-2xl border border-gray-100 bg-white" />}>
                <OfertaForm />
              </Suspense>
            </div>
          </div>
          ...
          <div className="space-y-6 lg:sticky lg:top-36 lg:self-start">
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-md">
              <h2 className="mb-4 font-bold">De ce PYTHA?</h2>
            ...
            <div className="flex gap-3">
              <div className="flex-1 rounded-2xl border border-gray-100 bg-white p-4 text-center shadow-md">
